...
namespace Examples.Scripts.Managers.Players
{
    public class ServerPlayersManager : MonoBehaviour
    {
        ...
        private Dictionary<uint, PlayerModel> _players;
        
        private void Awake()
        {
            _players = new Dictionary<uint, PlayerModel>();
        ...
        private void PlayerRequestSpawnDataframeHandler(PlayerSpawnRequestDataframe dataframe, uint id)
        {
        ...
        private void PlayerMoveDataframeHandler(PlayerMoveDataframe dataframe, uint id)
        {
